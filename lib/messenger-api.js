...
export function validateTarget(target) {
  ...
  if (target.threadId !== undefined && target.threadId !== null) out.threadId = target.threadId
  return out
}
...
export function normalizeAskBody(payload) {
  ...
  return { text, buttons: normalizeButtons(payload?.buttons) }
}
